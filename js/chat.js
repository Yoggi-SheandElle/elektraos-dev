...
(function () {
  ...
  var FAQ = {
    ...
    about: { p: ['who are you','about you','yourself','elektra','how many agent','your system','behind','how does it work'], r: ['I\'m Elektra - the assistant behind this site. I\'m backed by a multi-agent system with AI capabilities, built by Yossra, a full-stack engineer based in London. What would you like to know?'] },
    ...
    contact: { p: ['contact','email','reach','talk','call','meeting','book'], r: ['Email yossra.benzad@gmail.com or Start a project (link in the nav). I respond within 24 hours.'] },
    ...
    location: { p: ['where','location','copenhagen','denmark','remote'], r: ['Based in London, United Kingdom. Available worldwide for remote work. Timezone flexibility is not a problem.'] },
    ...
    hire: { p: ['hire','freelance','contract','available','collaborate','partnership','agent'], r: ['Open for projects, co-builds, and partnerships. I work via signed Statement of Work and direct invoicing. What are you building?'] }
  };
